...
export type CoManagementParticipantState = "pending" | "approved" | "revoked";
...
export interface CoManagementParticipant {
  id: string;
  displayName: string;
  role: CoManagementRole;
  state: CoManagementParticipantState;
  expiresAt: string;
  createdAt: string;
  approvedAt?: string;
  lastSeenAt?: string;
...
export interface CoManagementInvite {
  id: string;
  role: CoManagementRole;
  issuedAt: string;
  expiresAt: string;
...
export interface CoManagementConfigView {
  serverId: string;
  enabled: boolean;
  endpoint?: string;
...
export interface CoManagementServerSnapshot {
  serverId: string;
  serverName: string;
  gameKind: string;
  state: string;
  ...
  enabled: boolean;
  connectionState: string;
  participants: CoManagementParticipant[];
  invites: CoManagementInvite[];
}

export interface CoManagementSettingsSnapshot {
  serverId: string;
  gameKind: string;
  state: string;
  revision: number;
...
export interface CoManagementInviteResult {
  inviteId: string;
  role: CoManagementRole;
  expiresAt: string;
  inviteUrl: string;
...
export interface CoManagementSettingsInput {
  serverId: string;
  participantId: string;
}

export interface CoManagementApplyInput {
  serverId: string;
  participantId: string;
  role: CoManagementRole;
  requestId: string;
...
export interface CoManagementApplyResult {
  ...
  settings: CoManagementSettingsSnapshot;
  message: string;
}
...
export interface CoManagementJournalMigrationResult {
  serverId: string;
  migrated: number;
  remainingLegacy: number;
  databaseCompacted: boolean;
  message: string;
}

export interface CoManagementEvent {
  serverId: string;
  eventType: string;
  payload: Record<string, unknown>;
}

export interface ConfigureCoManagementInput {
  serverId: string;
  endpoint?: string;
  enabled: boolean;
}

export interface CoManagementParticipantInput {
  serverId: string;
  participantId: string;
}

export interface IssueCoManagementInviteInput {
  serverId: string;
  role: CoManagementRole;
  expiresMinutes?: number;
}

export interface CoManagementHostResponseInput {
  serverId: string;
  requestId: string;
  ok: boolean;
  result?: unknown;
