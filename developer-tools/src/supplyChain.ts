...
export function createCycloneDx(report: DeveloperInspectionReport) {
  ...
  return {
    ...
    metadata: {
      ...
      tools: { components: [{ type: "application", name: developerBrand.productName, version: "0.3.1", description: `Read-only release and supply-chain inspection tools for ${developerBrand.consumerProductName}.` }] },
      component: {
        type: "application",
        "bom-ref": rootRef,
        ...
        properties: [{ name: "msh:display-title", value: developerBrand.consumerProductName }],
      },
    },
    components,
    dependencies: [
...
export function createSpdx(report: DeveloperInspectionReport) {
  ...
  return {
    ...
    name: `${developerBrand.consumerProductName} ${report.expectedVersion} dependencies`,
    ...
    documentComment: `${developerBrand.consumerProductName} — ${developerBrand.descriptorEn}. Dependency inventory generated by ${developerBrand.productName}.`,
    creationInfo: { created: report.inspectedAt, creators: [`Tool: ${developerBrand.productName}-0.3.1`] },
