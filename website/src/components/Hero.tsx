    ...
    <section className="hero" id="top" aria-labelledby="hero-title">
      <div className="hero-copy">
        ...
        <div className="hero-actions" aria-label="主な操作">
          <a className="button button-primary" href={releaseStatus.installerUrl}><MonitorDown aria-hidden="true" />0.4.4候補を確認</a>
          <a className="button button-secondary" href="#features"><List aria-hidden="true" />機能を見る</a>
        </div>
        <p className="unofficial-note">公開予定 0.4.4・TomoNode名称変更版・Minecraft／Palworldの公式製品ではありません</p>
      </div>
