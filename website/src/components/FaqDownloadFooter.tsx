...
const faqs = [
  ...
  { q: "いつダウンロードできますか？", a: "Windows x64向けの0.4.1リリース候補ビルドを準備しています。正式名称、Tauri更新署名、一般公開URL、一般利用者環境でのインストール検証が完了した後、このサイトで案内します。" },
];
...
export function FaqDownloadFooter() {
  return <>
    ...
    <section className="download-section" id="download" aria-labelledby="download-title"><MonitorDown aria-hidden="true" /><div><h2 id="download-title">Windows版を準備中</h2><p>0.4.1のリリース候補を準備中です。未署名ファイルや架空のダウンロード先には接続しません。</p></div><button className="button button-disabled" type="button" disabled>ダウンロード準備中</button></section>
